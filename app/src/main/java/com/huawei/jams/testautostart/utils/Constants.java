...
public class Constants {
    ...
    //public static final String[] BOX_ID_ARRAY = new String[]{"Z01", "Z02", "Z03", "Z04", "Z05", "Z06", "Z07", "A01"};
    ...
    public static final long ANIMA_DURATION_MILL_SECOND =  ONE_MILL_SECOND/2;//动画播放时间
